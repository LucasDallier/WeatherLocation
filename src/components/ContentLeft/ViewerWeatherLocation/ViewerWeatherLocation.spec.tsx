...
import { ViewerWeatherLocation } from ".";
...
describe("Viewer Weather Location Component", () => {
  it("displaying the information correctly", () => {
    render(<ViewerWeatherLocation dataWeatherLocation={DataWeatherLocation} />);

    const myElement = screen.getByTestId("viewer-weather-location");

    expect(myElement).toHaveTextContent("Goiânia");
    ...
    expect(myElement).toHaveTextContent("Clouds");
  });
});
